...
namespace Service.Services.Abstract
{
    public interface IUserService
    {
        ...
        IEnumerable<ReadUserReferencelessDTO?> GetAllUsers();
        IEnumerable<ReadUserReferencelessDTO?> GetUsersByUsername(string username, CancellationToken cancellationToken);
